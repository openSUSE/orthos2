...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=set_ipv4_machine_defaults,
        ),
        migrations.RunPython(
            code=set_ipv6_machine_defaults,
        ),
        migrations.AddField(
            model_name="bmc",
            name="ip_address_v4",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="unknown",
                        help_text="The name of the network. Should at least relate to an existing Domain object.",
                        max_length=256,
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        help_text="The end of the range.", protocol="IPv4"
                    ),
                ),
                (
                    "dynamic_range_v4_start",
                    models.GenericIPAddressField(
                        help_text="The start of the range.", protocol="IPv4"
                    ),
                ),
                (
                    "dynamic_range_v6_end",
                    models.GenericIPAddressField(
                        help_text="The end of the range.", protocol="IPv6"
                    ),
                ),
                (
                    "dynamic_range_v6_start",
                    models.GenericIPAddressField(
                        help_text="The start of the range.", protocol="IPv6"
                    ),
                ),
            ],
            options={
