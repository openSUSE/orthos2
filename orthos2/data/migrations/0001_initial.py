# Generated by Django 2.2.8 on 2020-10-20 16:44
...
import orthos2.data.models.remotepower
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remote_power_device', models.ForeignKey(blank=True, limit_choices_to=orthos2.data.models.remotepower.RemotePower.limit_remote_power_device_choices, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='data.Machine')),
            ],
        ),
        migrations.CreateModel(
            name='DominionPX',
