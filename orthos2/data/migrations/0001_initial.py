    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=64,
                        null=True,
                        verbose_name="DHCP filename",
                    ),
                ),
                ("contact_email", models.EmailField(blank=True, max_length=254)),
                (
                    "dhcpv4_write",
                    models.BooleanField(default=True, verbose_name="Write DHCPv4"),
                ),
                (
                    "dhcpv6_write",
                    models.BooleanField(default=True, verbose_name="Write DHCPv6"),
                ),
                (
                    "updated",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cpu_model",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="CPU model"
                    ),
                ),
                ("cpu_flags", models.TextField(blank=True, verbose_name="CPU flags")),
                (
                    "cpu_physical",
                    models.IntegerField(default=1, verbose_name="CPU sockets"),
                ),
                ("cpu_cores", models.IntegerField(default=1, verbose_name="CPU cores")),
                (
                    "cpu_threads",
                    models.IntegerField(default=1, verbose_name="CPU threads"),
                ),
                (
                    "cpu_speed",
                    models.DecimalField(
                        ...
                        default=0,
                        max_digits=10,
                        verbose_name="CPU speed (MHz)",
                    ),
                ),
                (
                    "cpu_id",
                    models.CharField(blank=True, max_length=200, verbose_name="CPU ID"),
                ),
                (
                    "ram_amount",
                    models.IntegerField(default=0, verbose_name="RAM amount (MB)"),
                ),
                ("efi", models.BooleanField(default=False, verbose_name="EFI boot")),
                (
                    "nda",
                    models.BooleanField(default=False, verbose_name="NDA hardware"),
                ),
                (
                    "ipmi",
                    models.BooleanField(default=False, verbose_name="IPMI capability"),
                ),
                (
                    "vm_capable",
                    models.BooleanField(default=False, verbose_name="VM capable"),
                ),
                ("vm_max", models.IntegerField(default=5, verbose_name="Max. VMs")),
                (
                    "vm_dedicated_host",
                    models.BooleanField(
                        default=False, verbose_name="Dedicated VM host"
                    ),
                ),
                (
                    "vm_auto_delete",
                    models.BooleanField(
                        default=False, verbose_name="Delete automatically"
                    ),
                ),
                (
                    "virtualization_api",
                ...
                (
                    ...
                    models.DateTimeField(
                        default="1990-10-03T10:00:00+00:00", editable=False
                    ),
                ),
                (
                    "disk_primary_size",
                    models.SmallIntegerField(
                        blank=True, null=True, verbose_name="Disk primary size (GB)"
                    ),
                ),
                ...
                (
                    "status_ssh",
                    models.BooleanField(
                        default=False, editable=False, verbose_name="SSH"
                    ),
                ),
                (
                    "status_login",
                    models.BooleanField(
                        default=False, editable=False, verbose_name="Login"
                    ),
                ),
                (
                    "administrative",
                    models.BooleanField(
                        default=False, verbose_name="Administrative machine"
                    ),
                ),
                (
                    "check_connectivity",
                ...
                (
                    ...
                    models.SmallIntegerField(
                        choices=[
                            (0, "Write DHCP record"),
                            (1, "Ignore DHCP requests"),
                            (2, "Exclude DHCP record"),
                        ],
                        default=0,
                        verbose_name="DHCPv4",
                    ),
                ...
                (
                    "dhcpv6_write",
                    models.SmallIntegerField(
                        choices=[(0, "Write DHCP record"), (2, "Exclude DHCP record")],
                        default=0,
                        verbose_name="DHCPv6",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "setup_use_architecture",
                    models.BooleanField(
                        default=False,
                        verbose_name="Use machines architecture for setup",
                    ),
                ),
                (
                    "updated",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reserved_reason",
                    models.CharField(max_length=512, verbose_name="Reservation reason"),
                ),
                (
                    "updated",
                    models.DateTimeField(auto_now=True, verbose_name="Updated at"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_cartridge",
                    models.BooleanField(default=False, verbose_name="Cartridge/Blade"),
                ),
                ("description", models.CharField(blank=True, max_length=512)),
                (
                    "updated",
                ...
                (
                    "vendor",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="data.vendor"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        validators=[
                            orthos2.data.models.networkinterface.validate_mac_address
                        ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="data.MachineGroupMembership", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            model_name="machinegroup",
        ...
        migrations.AddField(
            ...
            name="system",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="data.system"
            ),
        ),
        migrations.AddField(
            model_name="machine",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kernelversion",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Kernel version"
                    ),
                ),
