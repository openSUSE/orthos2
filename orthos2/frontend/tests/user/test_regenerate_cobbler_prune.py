...
class RegenerateCobblerPruneViewTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        Domain.objects.filter(name="orthos2.test").update(cobbler_server=self.cobbler_server)

    @mock.patch("orthos2.frontend.views.regenerate.CobblerServer")
    def test_regenerate_domain_cobbler_diff(self, mocked_cobbler_server: mock.MagicMock) -> None:
    ...
    @mock.patch("orthos2.frontend.views.regenerate.CobblerServer")
    def test_regenerate_domain_cobbler_prune(self, mocked_cobbler_server: mock.MagicMock) -> None:
