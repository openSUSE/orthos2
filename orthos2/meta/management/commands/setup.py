...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument("--buildroot", type=pathlib.Path, default=None)
        parser.add_argument(
        ...
        parser.add_argument(
            "--directory-extended-data", type=pathlib.Path, default="/usr/share/orthos2"
        )
        parser.add_argument(
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        if buildroot is None:
            ...
            dir_orthos2_extended_data = options["directory_extended_data"]
            ...
            dir_orthos2_extended_data = buildroot / str(
                options["directory_extended_data"]
            ).lstrip("/")
        ...
        if what == CHOICE_ALL:
            ...
            self.install_ansible(dir_orthos2_extended_data, overwrite=overwrite)
