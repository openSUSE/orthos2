...
urlpatterns += PlatformInfoCommand.get_urls()  # noqa: F405
...
urlpatterns += AddPlatformCommand.get_urls()  # noqa: F405
...
urlpatterns += DeletePlatformCommand.get_urls()  # noqa: F405
urlpatterns += EditCommand.get_urls()  # noqa: F405
urlpatterns += EditManufacturerCommand.get_urls()  # noqa: F405
urlpatterns += EditPlatformCommand.get_urls()  # noqa: F405
