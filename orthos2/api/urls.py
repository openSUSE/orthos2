...
urlpatterns += DomainArchitectureInfoCommand.get_urls()  # noqa: F405
urlpatterns += DomainInfoCommand.get_urls()  # noqa: F405
...
urlpatterns += AddDomainArchitectureCommand.get_urls()  # noqa: F405
urlpatterns += AddDomainCommand.get_urls()  # noqa: F405
urlpatterns += AddNetworkInterfaceCommandGet.get_urls()  # noqa: F405
urlpatterns += AddNetworkInterfaceCommandPost.get_urls()  # noqa: F405
...
urlpatterns += EditDomainArchitectureCommand.get_urls()  # noqa: F405
urlpatterns += EditDomainCommand.get_urls()  # noqa: F405
urlpatterns += EditNetworkInterfaceCommand.get_urls()  # noqa: F405
urlpatterns += EditSerialConsoleCommandGet.get_urls()  # noqa: F405
urlpatterns += EditSerialConsoleCommandPost.get_urls()  # noqa: F405
