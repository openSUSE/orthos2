...
urlpatterns += VendorInfoCommand.get_urls()  # noqa: F405
...
urlpatterns += AddVendorCommand.get_urls()  # noqa: F405
...
urlpatterns += DeleteVendorCommand.get_urls()  # noqa: F405
urlpatterns += EditCommand.get_urls()  # noqa: F405
urlpatterns += EditVendorCommand.get_urls()  # noqa: F405
